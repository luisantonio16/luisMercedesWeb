          ...
          <section className="curriculum-left">
              ...
              <div className="timeline-items">
                ...
                <div className="timeline-description">
                  ...
                  <p className="timeline-info">
                    Polictenico nuestra señora de la Altagracia.
                  </p>
                </div>
              </div>
            </article>
            ...
            <div className=" curriculum-experiencia">
              ...
              <article className="curriculum-timelines">
                <div className="timeline-items">
                  <div className="timeline-header">
                    <h3 className="timeline-years">2022-2023</h3>
                    <span className="timeline-company">
                      Archangeli Corporation
                    </span>
                  </div>
                  ...
                  <div className="timeline-description">
                    ...
                    <p className="timeline-info">
                      Encargado de desarrollar y diseñar la web de la empresa.
                    </p>
                  </div>
                </div>
              </article>
              ...
              <article className="curriculum-timelines">
                <div className="timeline-items">
                  <div className="timeline-header">
                    <h3 className="timeline-years">2023-presente</h3>
                    <span className="timeline-company"></span>
                  </div>

                  <div className="timeline-divisor"></div>

                  <div className="timeline-description">
                    <h3 className="timeline-title">Tecklas</h3>
                    <p className="timeline-info">
                      Desarrollador Web full stack,
                    </p>
                    <p className="timeline-info">
                     utilizando, react, vue, c#, sql server.
                    </p>
                  </div>
                </div>
              </article>
            ...
            <section>
              <header className="curriculum-subheader">
                <h2 className="subheader-title">
                  Habilidades en{" "}
                  <span className="subheader-subtitle">Codigo</span>
                </h2>
              </header>
